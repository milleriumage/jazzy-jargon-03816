...
export type Screen = 'home' | 'store' | 'manage-subscription' | 'history' | 'rewards' | 'create-content' | 'creator-payouts' | 'developer-panel' | 'my-creations' | 'account' | 'view-creator' | 'ux-kit' | 'design-studio' | 'pix-payment' | 'livepix-payment' | 'user-plan-management' | 'showcase-management' | 'outfit-generator' | 'theme-generator' | 'my-bio' | 'my-funs';
