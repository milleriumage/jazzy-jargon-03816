                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="flex items-center space-x-6">
                     ...
                     <div>
                        ...
                        <input type="email" name="email" id="email" value={formData.email || ''} disabled className="mt-1 block w-full bg-neutral-700 border-neutral-600 rounded-md py-2 px-3 text-neutral-500 cursor-not-allowed" />
